// lib/screens/sqlite_screen.dart
...
class _SQLiteScreenState extends State<SQLiteScreen> {
  ...
  List<SQLiteProductWithCategory> _products = [];
  List<SQLiteCategory> _categories = [];
  ...
  Future<void> _loadData() async {
    ...
    final products = await _db.getProductsWithCategory();
    final categories = await _db.readAllCategories();
    setState(() {
      _products = products;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('SQLite Products'),
  ...
  void _showProductOptions(SQLiteProductWithCategory item) {
  ...
  void _showEditProductDialog(SQLiteProduct product) {
  ...
  void _confirmDeleteProduct(SQLiteProduct product) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Delete Product'),
  ...
  void _deleteCategory(SQLiteCategory category) async {
